...
export class ScopingController {
    ...
    async generatePreAuditReport(@Body() dto: GenerateReportDto): Promise<PreAuditReport> {
        try {
            this.logger.log(`Received request to generate report for ${dto.owner}/${dto.repo}`);
            ...
            this.logger.log(`Successfully generated report for ${dto.owner}/${dto.repo}`);
            return report;
