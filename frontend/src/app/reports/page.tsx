  ...
  const filterAndSortReports = useCallback(() => {
    ...
    filtered.sort((a, b) => {
      ...
      switch (sortBy) {
        ...
        case "score":
          aValue =
            (a.scores.structural.score +
              a.scores.security.score +
              a.scores.systemic.score +
              a.scores.economic.score) /
            4;
          bValue =
            (b.scores.structural.score +
              b.scores.security.score +
              b.scores.systemic.score +
              b.scores.economic.score) /
            4;
          break;
        case "repository":
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-4">
              <button
                ...
                className="flex items-center px-4 py-2 cursor-pointer bg-blue-600 text-white rounded-md hover:bg-blue-700 disabled:opacity-50 disabled:cursor-not-allowed text-sm"
              >
