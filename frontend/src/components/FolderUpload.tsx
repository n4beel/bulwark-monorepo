...
import { Upload, FileArchive, X, CheckCircle, AlertCircle, ArrowRight } from 'lucide-react';
...
interface FolderUploadProps {
    onUploadSuccess: (extractedPath: string, contractFiles: ContractFile[]) => void;
    onBack?: () => void;
}
...
export default function FolderUpload({ onUploadSuccess, onBack }: FolderUploadProps) {
        ...
        <div className="max-w-4xl mx-auto">
            <div className="bg-white rounded-lg shadow-lg p-6">
                ...
                <div className="flex items-center justify-between mb-6">
                    <div>
                        <h2 className="text-2xl font-bold text-gray-900">Upload Contract Folder</h2>
                        <p className="text-gray-600 mt-1">
                            Upload a zipped folder containing your smart contract files for analysis
                        </p>
                    </div>
                    {onBack && (
                        <button
                ...
                <div className="mb-6 bg-gray-50 border border-gray-200 rounded-lg p-4">
                    <h4 className="font-semibold text-gray-900 mb-2">Upload Instructions</h4>
                    <ul className="text-sm text-gray-600 space-y-1">
                        <li>• Compress your smart contract project folder into a .zip, .tar.gz, .7z, or .rar file</li>
                        <li>• Ensure your contracts are in common directories like /contracts, /src, or /programs</li>
