...
export default function RepositorySelector({ accessToken, onSelect, onBack }: RepositorySelectorProps) {
                                ...
                                <div className="flex items-start justify-between">
                                    <div className="flex-1">
                                        <div className="flex items-center mb-2">
                                            ...
                                            <h3 className="font-bold text-gray-900 text-lg">{repo.name}</h3>
                                            {repo.private ? (
                                        ...
                                        <div className="flex items-center space-x-4 text-sm text-gray-700">
                                            {repo.language && (
                                                <div className="flex items-center">
                                                    <div className={`w-4 h-4 rounded-full ${getLanguageColor(repo.language)} mr-2`}></div>
