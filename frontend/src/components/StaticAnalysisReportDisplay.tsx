              ...
              <div className="bg-white rounded-lg border border-gray-200">
                <div className="px-6 py-4 border-b border-gray-200">
                  ...
                  <p className="text-sm text-gray-600 mt-1">
                    Comprehensive list of all analyzed factors and metrics
                  </p>
                </div>
                <div className="p-6">
                  ...
                  <div className="mt-8 space-y-6">
                    ...
                    {/* {report.analysisFactors.standardLibraryUsage.length > 0 && (
                      <div>
                        ...
                        <div className="flex flex-wrap gap-2">
                          {report.analysisFactors.standardLibraryUsage.map(
                            (lib, index) => (
                              <span
                                key={index}
                    ...
                    {/* {report.analysisFactors.knownProtocolInteractions.length >
                      ...
                      <div>
                        ...
                        <div className="flex flex-wrap gap-2">
                          {report.analysisFactors.knownProtocolInteractions.map(
                            (protocol, index) => (
                              <span
                                key={index}
                    ...
                    {/* {report.analysisFactors.anchorSpecificFeatures
                      ...
                      <div>
                        ...
                        <div className="flex flex-wrap gap-2">
                          {report.analysisFactors.anchorSpecificFeatures.programDerives.map(
                            (derive, index) => (
                              <span
                                key={index}
                    ...
                    {/* {report.analysisFactors.oracleUsage.length > 0 && (
                      <div>
                        ...
                        <div className="space-y-2">
                          {report.analysisFactors.oracleUsage.map(
                            (oracle, index) => (
                              <div
                                key={index}
                              ...
                              >
                                <div>
                                  ...
                                  <span className="ml-2 text-sm text-gray-600">
                                    ({oracle.functions.length} functions)
                                  </span>
                                </div>
                                <span
                    ...
                    {/* {report.analysisFactors.defiPatterns.length > 0 && (
                      <div>
                        ...
                        <div className="space-y-2">
                          {report.analysisFactors.defiPatterns.map(
                            (pattern, index) => (
                              <div
                                key={index}
                                className="flex items-center justify-between p-3 bg-gray-50 rounded-lg"
                    ...
                    {/* {report.analysisFactors.economicRiskFactors.length > 0 && (
                      <div>
                        ...
                        <div className="space-y-2">
                          {report.analysisFactors.economicRiskFactors.map(
                            (risk, index) => (
                              <div
                                key={index}
                                className="flex items-center justify-between p-3 bg-gray-50 rounded-lg"
                              >
                                <div>
                                  ...
                                  <span className="ml-2 text-sm text-gray-600">
                                    Count: {risk.count}, Weight: {risk.weight}
                                  </span>
                                </div>
                                <span
                    ...
                    {/* {report.analysisFactors.crossProgramInvocation.length >
                      ...
                      <div>
                        ...
                        <div className="flex flex-wrap gap-2">
                          {report.analysisFactors.crossProgramInvocation.map(
                            (cpi, index) => (
                              <span
                                key={index}
